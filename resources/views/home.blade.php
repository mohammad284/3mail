...
<body class="tg-login">
	...
	<div id="tg-wrapper" class="tg-wrapper tg-haslayout">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="/"><img class="logo__img" src="images/logo.png" alt="company logo here"></a></strong>
						...
						<nav id="tg-nav" class="tg-nav">
							...
							<div id="tg-navigation" class="collapse navbar-collapse tg-navigation">
								<ul>
									...
									<li class="menu-item-has-children">
										<a class="sing-in" href="#!"><i class="fas fa-sign-in-alt"></i><span>تسجيل الدخول </span></a>
									</li>
									<li class="menu-item-has-children">
										<a class="sing-in" href="#"><i class="fa fa-user" aria-hidden="true"></i>انشاء حساب</a>
									</li>
								</ul>
							</div>
						</nav>
		...
		*************************************-->
		<!--************************************
				Inner Banner Start
		*************************************-->
		<section class="tg-parallax tg-innerbanner" data-appear-top-offset="600" data-parallax="scroll" data-image-src="images/makah.jpg">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<ol class="tg-breadcrumb">
								...
								<li class="tg-active">ملفي الشخصي</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<aside id="tg-sidebar" class="tg-sidebar">
									<div class="tg-widget tg-widgetdashboard">
										...
										<div class="tg-widgetcontent">
											<ul>
												<li class="selected"><a href="dashboard.html"><i class="icon-user"></i><span>معلومات الحساب</span></a></li>
												<li><a href="my-profile.html"><i class="icon-pen2"></i><span>تعديل الحساب</span></a></li>
												<li><a href="change-password.html"><i class="icon-lock-open3"></i><span>تغيير كلمة السر</span></a></li>
												<li><a href="my-booking.html"><i class="icon-basket3"></i><span>حجوزاتي</span></a></li>
												<li><a href="my-wish-list.html"><i class="icon-heart"></i><span>رغباتي</span></a></li>
												<li><a href="#"><i class="icon-lock"></i><span>تسجيل خروج</span></a></li>
											</ul>
										</div>
									</div>
								</aside>
									...
									<div class="tg-dashboard">
										<div class="tg-box tg-profile">
											<div class="tg-heading">
												<h3>ملفي الشخصي</h3>
												<a class="tg-btnedit" href="my-profile.html">تعديل الحساب</a>
											</div>
											<div class="tg-dashboardcontent">
												<figure><img src="img2/man1.jpg" alt="image description"></figure>
												<div class="tg-content">
													<ul class="tg-liststyle">
														<li><span>الاسم</span></li>
														<li><span>محمد مصطفى كامل حمد</span></li>
														<li><span>البريد الإلكتروني</span></li>
														<li><span>example@email.com</span></li>
														<li><span>رقم الهاتف</span></li>
														<li><span>1-800-321-6549</span></li>
														<li><span>عنوان الإتصال </span></li>
					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
							<div class="tg-footercolumn tg-widget tg-widgettext">
								<div class="logo"><a class="logo__link" href="/home"><img class="logo__img" src="images/logo.png" alt="Doremi"></a></div>
						...
						<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
							<div class="tg-footercolumn tg-widget tg-widgetdestinations">
								...
								<div class="tg-widgetcontent">
									<ul>
										<li> <a href="page-typography.html">مكة المكرمة</a></li>
										<li> <a href="page-typography.html">جدة</a></li>
										<li> <a href="page-typography.html">الرياض</a></li>
										<li> <a href="page-typography.html">المدينة المنورة</a></li>
										<li> <a href="page-typography.html">نجران</a></li>
										<li> <a href="page-typography.html">الدمام</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
							<div class="tg-footercolumn tg-widget tg-widgetnewsletter">
								...
								<div class="tg-widgetcontent">
									<ul class="uk-list">
										<li> <span>البريد الالكتروني: </span><a href="mailto:support@domain.com">support@domain.com</a></li>
										<li> <span>الهاتف: </span><a href="tel:104023513690">+1 (040) 2351 3690</a></li>
									  </ul>
									  <ul class="social">
	...
	*************************************-->
	...
	<script src="js/vendor/bootstrap-arabic.min.js"></script>
